 ...
 */
public class TwinTracPackageBattery extends TwinTracData
{
	public static final byte PACKAGE_NUMBER = 0x09;


	public TwinTracPackageBattery()
	{
		super(TwinTracDataCreator.BATTERY_CMD, PACKAGE_NUMBER, new byte[] {});
	}
}
